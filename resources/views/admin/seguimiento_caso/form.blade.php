...
<div>
    ...
    <textarea class="form-control" id="descripcion" name="descripcion" type="text" >{{ isset($seguimiento_caso->descripcion) ? $seguimiento_caso->descripcion : ''}}</textarea>
...
<div>
    ...
    <select class="" id="registroatencion_id" name="registroatencion_id" data-maximum-selection-length="10">
