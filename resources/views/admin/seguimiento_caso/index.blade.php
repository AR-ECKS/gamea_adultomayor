                                    ...
                                    <table class="table table-sm text-sm table-striped">
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col" class="px-6 py-3">Tipologia</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="">
                                                    ...
                                                    <a href="{{ route('seguimiento_caso.show', $item->id) }}" class="btn-sm btn-info" title="Ver detalles"> <i class="far fa-eye"></i></a>
                                                    <a href="{{ route('seguimiento_caso.edit', $item->id) }}" class="btn-sm btn-secondary"> <i class="fas fa-edit"></i></a>
                                                    <a href="{{ route('seguimiento_caso.generateForm', $item->id) }}" class="btn-sm btn-warning" target="_blank" title="Ver detalles"> <i class="fas fa-print"></i></a>
                                                    <form action="{{ route('seguimiento_caso.delete', $item->id) }}" method="POST" style="display: inline-block;" class="form-eliminar">
                                                        @csrf
                                                        @method('DELETE')
                                                    ...
                                                    @else
                                                    <a href="{{-- route('/admin/seguimiento_caso', $item->id) --}}" class="btn-sm btn-dark" data-toggle="tooltip" data-placement="top" title="Restaurar">
