<x-layout bodyClass="g-sidenav-show  bg-gray-200">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        <x-navbars.navs.auth titlePage="Adulto mayor"></x-navbars.navs.auth>
                        ...
                        <div class="card-body p-3">
                            <div class="float-end mt-3">
                                <a type="button" class="btn btn-dark" data-bs-toggle="modal"
                                    ...
                                    <i class="fas fa-database"></i> Nuevo Adultomayor
                                </a>
                            </div>
                            <br><br><br>
                            <div class="tab-content">
                                <div class="table-responsive-xl">
                                    <table class="table table-sm text-sm table-striped">
                                        ...
                                        <tbody>
                                            @foreach ($adultomayor as $item)
                                                <tr>
                                                    <td >
                                                        @if ($item->estado == 1)
                                                            <a href="{{ route('adultomayor.show', $item->id) }}"
                                                                class="btn-sm btn-info" title="Ver detalles"> <i
                                                                    class="far fa-eye"></i></a>
                                                            <a href="{{ route('adultomayor.edit', $item->id) }}"
                                                                class="btn-sm btn-secondary"> <i
                                                                    class="fas fa-edit"></i></a>
                                                            <form action="{{ route('adultomayor.delete', $item->id) }}"
                                                        ...
                                                        @else
                                                            <a href="{{ route('adultomayor.reingresar', $item->id) }}"
        ...
        @include ('admin.adulto-mayor.create')
