<x-layout bodyClass="g-sidenav-show  bg-gray-200">
    <x-navbars.sidebar activePage="Coordinacion"></x-navbars.sidebar>
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        <x-navbars.navs.auth titlePage="Coordinacion"></x-navbars.navs.auth>
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body p-3">
                            ...
                            <a type="button" class="btn btn-dark" href="{{ route('coordinacion_caso.create') }}">
                            ...
                            <div class="tab-content">
                                <div class="table-responsive-xl">
                                    ...
                                    <tr>
                                        <th>#</th>
                                        <th scope="col" class="px-6 py-3">Fecha</th><th scope="col" class="px-6 py-3">Intervencion</th><th scope="col" class="px-6 py-3">Requerimiento</th>
                                        <th>Estado</th>
                                        <th class="text-end">Acciones</th>
                                    </tr>
                                </thead>
                                <tbody>
                                            @foreach ($coordinacion_caso as $item)
                                                <tr>
                                                    <td >
                                                        @if ($item->estado == 1)
                                                            <a href="{{ route('coordinacion_caso.show', $item->id) }}"
                                                                class="btn-sm btn-info" title="Ver detalles"> <i
                                                                    class="far fa-eye"></i></a>
                                                            <a href="{{ route('coordinacion_caso.edit', $item->id) }}"
