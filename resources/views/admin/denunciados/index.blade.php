                        ...
                        <div class="card-body p-3">
                            <div class="float-end mt-3">
                                <a type="button" class="btn btn-dark" data-bs-toggle="modal"
                                    ...
                                    <i class="fas fa-database"></i> Nuevo Denunciados
                                </a>
                            </div>
                            <br><br><br>
                            <div class="tab-content">
                                <div class="table-responsive-xl">
                                    ...
                                    <tr>
                                        <th>#</th>
                                        <th scope="col" class="px-6 py-3">Nombre Completo</th><th scope="col" class="px-6 py-3">Adultomayor Id</th>
                                        <th>Estado</th>
                                ...
                                @foreach($denunciados as $item)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4">{{ $item->nombre_completo }}</td><td class="px-6 py-4">{{ $item->adultomayor_id }}</td>
                                        <td>
                                            @if ($item->estado == 1)
                                        ...
                                        <td class="text-end">
                                            ...
                                            <a href="{{ route('/admin/denunciados/', $item->id) }}"
                                                class="btn-sm btn-info" title="Ver detalles"> <i
                                                    class="far fa-eye"></i></a>
                                            <a href="{{ route('/admin/denunciados/', $item->id) }}"
                                                        class="btn-sm btn-secondary"> <i
                                                            class="fas fa-edit"></i></a>
                                            <form action="{{ route('/admin/denunciados', $item->id) }}"
...
@include ('admin.Denunciados.create')
