                            ...
                            <form action="{{ route('users.store') }}" method="post" class="form-horizontal"
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="username" required
                                            maxlength="15" id="username" placeholder=""
                                            value="{{ old('username') }}">
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    ...
                                    <div class="col-md-7">
                                        <input type="text" class="form-control" required name="ci"
                                            maxlength="20" placeholder="" value="{{ old('ci') }}">
                                    </div>
                                    <div class="col-md-2">
                                        <select class="form-control" required name="extension">
                                            <option value="" selected disabled>Selecciona una extensión</option>
                                            <option value="LP" {{ old('extension') == 'LP' ? 'selected' : '' }}>LP
                                            </option>
                                            <option value="CB" {{ old('extension') == 'CB' ? 'selected' : '' }}>CB
                                            </option>
                                            <option value="SC" {{ old('extension') == 'SC' ? 'selected' : '' }}>SC
                                            </option>
                                            <option value="BE" {{ old('extension') == 'BE' ? 'selected' : '' }}>BE
                                            </option>
                                            <option value="PD" {{ old('extension') == 'PD' ? 'selected' : '' }}>PD
                                            </option>
                                            <option value="TJ" {{ old('extension') == 'TJ' ? 'selected' : '' }}>TJ
                                            </option>
                                            <option value="OR" {{ old('extension') == 'OR' ? 'selected' : '' }}>OR
                                            </option>
                                            <option value="PT" {{ old('extension') == 'PT' ? 'selected' : '' }}>PT
                                            </option>
                                            <option value="CH" {{ old('extension') == 'CH' ? 'selected' : '' }}>CH
                                            </option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9 position-relative">
                                        <div class="input-group" style="width: 94%;">
                                            <input type="password" class="form-control form-control-eye" name="password"
                                                id="password" placeholder="" oninput="checkPasswordStrength()">
                                        </div>
                                    ...
                                    <div class="col-md-9 position-relative">
                                        <div class="input-group" style="width: 94%;">
                                            <input type="password" class="form-control" name="password_confirmation"
                                                required id="password_confirmation" placeholder=""
                                ...
                                <div class="input-file-container">
                                    <div class="input-file">
                                        <p class="input-file__name">Subir imagen</p>
                                        <button type="button" class="input-file__button">
                                            <i class="fas fa-upload"></i>
                                        </button>
                                        <input type="file" class="fileInpt" name="imagen" type="file"
                                            id="avatarInput" value="{{ isset($user->imagen) ? $user->imagen : '' }}">
                                    </div>
                                    <img src="https://i.ibb.co/0Jmshvb/no-image.png" class="image-preview"
                                        alt="preview image">
                                </div>



                                <button type="submit" class="btn btn-success" style="float: right;">Registrar
                                    Usuario</button>
